            ...
            if init_max_model_length is not None and init_max_model_length != max_model_length:
                ...
                warnings.warn(
                    (
                        ...
                        f" sequences longer than {deprecated_max_model_length} you can either instantiate this"
                        " tokenizer with `model_max_length` or pass `max_length` when encoding/padding.\n- To avoid"
                        " this warning, please instantiate this tokenizer with `model_max_length` set to your"
                        " preferred value."
                    ),
                    FutureWarning,
                )
