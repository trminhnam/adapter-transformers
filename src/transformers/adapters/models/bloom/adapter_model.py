...
@add_start_docstrings(
    """
The Bloom Model that allows the loading of different heads dor different tasks. This enables a flexible use of the
...
class BloomModelWithHeads(BloomAdapterModel):
