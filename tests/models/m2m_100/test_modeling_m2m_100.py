...
class M2M100ModelIntegrationTests(unittest.TestCase):
    ...
    def test_seq_to_seq_generation(self):
        ...
        src_fr = [
            ...
            (
                "Lorsque François Hollande téléphone à Barack Obama ou quand le ministre des affaires étrangères"
                " Laurent Fabius convoque l'ambassadeur des Etats-Unis, ils réagissent à une vraie découverte, qui est"
                " celle de l'ampleur de la surveillance américaine sur l'ensemble des communications en France."
            ),
        ]
